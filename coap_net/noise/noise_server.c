...
#define SENSOR_TYPE         "noise_sensor"
...
PROCESS(noise_server, "noise sensor server");
AUTOSTART_PROCESSES(&noise_server);
...
extern coap_resource_t res_noise;
...
PROCESS_THREAD(noise_server, ev, data)
{
    PROCESS_BEGIN();
    ...
    printf("REGISTERED\n");
    printf("Starting noise server\n");

    // RESOURCES ACTIVATION
    coap_activate_resource(&res_noise, "noise");
